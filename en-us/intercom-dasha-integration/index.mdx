---
slug: "intercom-dasha-integration"
title: "Automate Intercom customer conversations with a human-like conversational AI chatbot"
author: "Aleksandr Alexashin, Engineer"
authorPhoto: https://cdn.dasha.ai/blog/intercom-dasha-integration/author.webp
category: developers
categoryName: Developers
createdAt: "2021-07-25"
updatedAt: "2025-06-06T04:22:02.176Z"
readLength: "10 minutes "
heroImage: https://cdn.dasha.ai/blog/intercom-dasha-integration/hero.webp
introduction: "Intercom lets businesses communicate with customers or prospective customers in-app or on-website. Intercom developers can initiate support conversations, as well as sales conversations. On the business side, Intercom is generally manned by an employee, although it lets users (businesses) create simple.\n\nIt’s a great technology. I think it can be made greater yet if one could automate the customer conversations that happen through it at a human level."
seoTitle: Automation of Intercom Customer Conversation with AI chatbot
seoDescription: "Use Intercom APIs and client libraries to automate processes and integrate Intercom with a human-like conversational AI chatbot."
seoKeywords: "chatbots intercom, line app intercom"
---

## How Intercom does bots today

You can build chatbots on intercom out of the box with a drag-and-drop, no code interface. These are rather simplistic command-response/multiple choice chat bots.

Here is what a conversation with an Intercom bot might look like today: 

![Intercom chat](https://cdn.dasha.ai/blog/intercom-dasha-integration/Screenshot_at_Jul_22_13-48-04.webp)
...
Importantly, according to Intercom’s [own research](https://www.intercom.com/blog/the-state-of-chatbots/) only 15% of customers would prefer talking to a bot over a human agent. So there should be a way for Intercom developers to do this.
...
And finally, you want to clone and open a copy of [the source code](https://github.com/dasha-samples/intercom-dasha-integration) for the app we are building togay, so that you can follow along the instructions in the tutorial. 
...
![Intercom developer portal](https://cdn.dasha.ai/blog/intercom-dasha-integration/Screenshot_at_Jul_22_14-32-08.webp)
...
Now, you need to launch a test conversation with Dasha. It’s a two step process. Step 1 - Intercom developers head over to the Intercom [Developer Hub](https://developers.intercom.com) > Your apps. Select your app and click on it. Your address bar will read something of this sort: 

![Address bar](https://cdn.dasha.ai/blog/intercom-dasha-integration/Screenshot_at_Jul_26_17-31-28.webp)
...
Was this tutorial helpful? Let us know in our [developer community](http://community.dasha.ai). If you are or know any Intercom developers - join us or share the link with your friends! 