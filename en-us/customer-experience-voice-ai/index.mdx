...
Fix feedback first. Capture one-to-two natural questions at resolution, log structured fields plus a short summary, keep transcripts for training, and map to your taxonomy. For recorded calls used in training or quality review, [speech enhancement techniques](https://dasha.ai/blog/short-guide-to-speech-enhancement) can reduce background noise and reverberation before analysis. Keep brand voice and avoid leading prompts.
