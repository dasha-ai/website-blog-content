---
slug: "voice-assistant-for-cars"
title: "How to build an in-car voice assistant with Dasha AI"
author: Anzhelika Minina
authorPhoto: https://cdn.dasha.ai/blog/voice-assistant-for-cars/author.jpg
category: developers
categoryName: Developers
createdAt: "2021-06-30T18:12:41.766Z"
updatedAt: "2021-07-30T06:28:49.815Z"
readLength: "11 minute read"
heroImage: https://cdn.dasha.ai/blog/voice-assistant-for-cars/hero.webp
introduction: "You have definitely heard of the rising popularity of in-car assistants. In the U.S. alone over 60% of people are inclined to buy a car with an assistant installed. Nearly [<u>130 million people</u>](https://voicebot.ai/2020/02/20/u-s-in-car-voice-assistant-users-rise-13-7-to-nearly-130-million-have-significantly-higher-consumer-reach-than-smart-speakers/) have already tried using one in their car and over 80 million enjoyed using their in-car voice assistant so much that they’re using it constantly. \n\nLet’s explore how you might go about creating your own in-car voice assistant app with Dasha conversational AI studio. An app that will not only provide you with basic information like weather conditions and navigation but would go a step further and analyze the in and out of car environment while offering and executing actions."
seoTitle: "How to build an in-car voice assistant with Dasha AI"
seoDescription: "Learn how to build a voice assistant app for your smart car project with a step-by-step guide"
seoKeywords: "voice assistant app, voice assistant for car, voice assistant car, how to make voice assistant app, how to create voice assistant app, in car voice assistant, car voice assistant, dasha AI, conversational AI app, conversational AI as a service"
---

## Voice assistants for cars are trending and here is why

In-car voice assistants are about to become present in every car on the market. Research conducted by [Capgemini](https://www.capgemini.com/wp-content/uploads/2019/11/Report-%E2%80%93-Voice-on-the-Go.pdf) shows that 95% of car owners are predicted to be using in-car conversational assistant by 2022, which is right around the corner. 
...
When you’re all set, go to Github and download the [Dasha in-car assistant](https://github.com/dasha-samples/dasha-in-car-assistant) demo. Open Visual Studio Code and open the folder with the code. Alternatively, you can clone the project directly from your terminal using  Let’s see what’s happening with the code and how you can make your own app based on it.

Go to __main.dsl__

![main.dsl](https://cdn.dasha.ai/blog/voice-assistant-for-cars/main.dsl.jpg)
...
![index.js](https://cdn.dasha.ai/blog/voice-assistant-for-cars/index.js.jpg)
...
![heat](https://cdn.dasha.ai/blog/voice-assistant-for-cars/heat.jpg)
